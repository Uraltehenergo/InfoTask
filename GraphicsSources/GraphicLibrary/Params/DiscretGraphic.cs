...
namespace GraphicLibrary
{
    ...
    #region ControlFunction
        private void AxCap_Click(object sender, EventArgs e)
        {
            try
            {
                //FormGraphic.CurGraphicNum = int.Parse(((Label)sender).Text);
                FormGraphic.CurGraphicNum = Num;
            }
            catch (Exception ex)
            {
