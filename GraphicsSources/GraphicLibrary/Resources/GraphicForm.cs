						...
						dataGridView1.Rows.Add(new IComparable[]
														  {
															  ...
															  , "", "", t.Units, "", //"",
															  t.Min.ToString(), t.Max.ToString(), t.Comment
														  });
					else
					{
                            ...
                            else
                            {
                                if (curP.Dots[curP.Dots.Count - 1].Time < timeEnd)
                                {
                                    ...
                                    if(curP.DataTypeD == DataType.Real)
                                    {
                                        ...
                                        val *= timeEnd.Subtract(curP.Dots[curP.Dots.Count - 1].Time).TotalMilliseconds/
                                               reader.GetTime("Time").Subtract(curP.Dots[curP.Dots.Count - 1].Time).TotalMilliseconds;
                                        val += a;
                                    }
                                    else
