...
namespace GrafeoLibrary
{
    ...
    */
    ...
    public class MomentValue<T>
    {
        ...
        public MomentValue(int nd) : this()
        {
            Nd = nd;
        }

        public MomentValue(DateTime time, int nd = 0) : this(nd)
        {
            Time = time;
        }

        public MomentValue(DateTime time, T mean, int nd): this(time, nd)
        {
            Mean = mean;
        }
    }
