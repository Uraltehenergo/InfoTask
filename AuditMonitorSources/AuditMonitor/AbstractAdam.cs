...
{
    //public abstract class ClassAbstractAdamModule
    //{
    //#region Static
    //    public static byte? HexToByte(string hex)
    //    {
    //        byte dec;
    //        if (byte.TryParse(hex, NumberStyles.HexNumber, CultureInfo.InvariantCulture.NumberFormat, out dec))
    //        {
    //            return dec;
    //        }
    //        return null;
    ...
    //    private string _address;                               //шестнадцатиричный адрес модуля (00 - FF)
    //    public string Name { get; protected set; }             //имя модуля
    //    public string FirmwareVersion { get; protected set; }  //версия ПО модуля
    //    public abstract string DataFormat { get; set; }        //тип единиц измерения
    //    public abstract string InputRange { get; set; }        //входной диапазон канала ("FF")
    //    public abstract string BaudRate { get; set; }          //скорость передачи данных ("06")

    //    public DateTime? Time { get; protected set; }          //время опроса модуля

    //    public readonly ClassAdamChannelsList Channel;         //список каналов
    //#endregion
    ...
    //        set
    //        {
    //            byte? adress10 = HexToByte(value);
    //            _address = (adress10 != null) ? value : null;
    //        }
    //    }

    //    public byte? Address10
    //    {
    //        get { return HexToByte(_address); }
    //        set { _address = (value != null) ? ByteToHex((byte)value) : null; }
    //    }
    ...
    //        {
    //            byte cnt = 0;
    //            foreach (ClassAbstractAdamChannel chn in Channel) { if (chn.Selected) cnt++; }
    //            return cnt;
    //        }
    //    }
        
    //    public abstract ClassAbstractAdamChannel Cjc{ get; }
    //#endregion 

    //#region Constructors/Destructors
    //    protected ClassAbstractAdamModule(string address, int channelCount)
    //    {
    //        byte? adress10 = HexToByte(address);
    //        Address = (adress10 != null) ? address : null;
            
    //        Channel = new ClassAdamChannelsList(channelCount);
    ...
    //    protected ClassAbstractAdamModule(byte address10, int channelCount)
    //    {
    //        Address = ByteToHex(address10);
    ...
    //    public abstract void ReadModule(bool readOnlySelected = true);

    //    //public virtual void ReadModuleNoRead(double secAdd = 0)
    //    //{
    //    //    if (Address != null)
    //    //    {
    //    //        DateTime time = (Time != null ? Time.Value.AddSeconds(secAdd) : DateTime.Now.AddSeconds(secAdd));
                
    //    //        foreach (ClassAbstractAdamChannel channel in Channel)
    //    //        {
    //    //            var signalValue = new ClassChannelValue(channel, time, EChannelStatus.NoRead);
    //    //            lock (Program.Net.QueueChannelValues) { Program.Net.QueueChannelValues.Enqueue(signalValue); }
    //    //        }
    //    //    }
    //    //}

    //    public virtual void ReadModuleNoRead(DateTime time)
    //    {
    //        if (Address != null)
    //        {
    //            foreach (ClassAbstractAdamChannel channel in Channel)
    ...
    //public abstract class ClassAbstractAdamChannel
    //{
    //#region Static
    //    public static double ChangeScale(double value, double oldMin, double oldMax, double newMin, double newMax)
    //    {
    //        if (oldMin != oldMax)
    ...
    //    public static double? MVtoThL(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] am = {
    //                          -5.8952244e-5, 
    //                          6.3391502e-2,  
    ...
    //        {
    //            val = cm[0];
    //            //for (int i = 1; i <= 9; i++) val += cm[i]*(Math.Pow(mvVal, i));
    //            for (int i = 1; i <= cm.GetUpperBound(0); i++) val += cm[i] * (Math.Pow(mvVal, i));
    //        }
    //        else
    //        {
    //            status = EChannelStatus.TransformOutOfRange;
    //            return null;
    //        }
    ...
    //    public static double? MVtoThK(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] am = {
    //                          0,
    //                          3.9450128025e-2,
    ...
    //        {
    //            mvCjc = a[0];
    //            //for (int i = 1; i <= 9; i++) mvCJC += a[i]*(Math.Pow(cjc, i));
    //            for (int i = 1; i <= a.GetUpperBound(0); i++) mvCjc += a[i] * (Math.Pow(cjc, i));
    ...
    //        {
    //            mvCjc = am[0];
    //            //for (int i = 1; i <= 10; i++) mvCJC += am[i]*(Math.Pow(cjc, i));
    //            for (int i = 1; i <= am.GetUpperBound(0); i++) mvCjc += am[i] * (Math.Pow(cjc, i));
    //        }
    //        else
    //        {
    ...
    //    public static double? MVtoThR(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] a1 = {
    //                          0,
    //                          5.28961729765e-3,
    ...
    //    public static double? MVtoThS(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] a1 = {
    //                          0,
    //                          5.40313308631e-3,
    ...
    //    public static double? MVtoThB(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] a1 = {
    //                          0,
    //                          -2.4650818346e-4,
    ...
    //    public static double? MVtoThJ(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] a1 = {
    //                          0,
    //                          5.0381187815e-2,
    ...
    //    public static double? MVtoThT(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] a1 = {
    //                          0,
    //                          3.8748106364e-2,
    ...
    //    public static double? MVtoThE(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] a1 = {
    //                          0,
    //                          5.8665508708e-2,
    ...
    //    public static double? MVtoThN(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] a1 = {
    //                          0,
    //                          2.6159105962e-2,
    ...
    //    public static double? MVtoThA1(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] a1 = {
    //                          7.1564735e-4,
    //                          1.1951905e-2,
    ...
    //    public static double? MVtoThA2(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] a1 = {
    //                          -1.0850558e-4,
    //                          1.1642292e-2,
    ...
    //    public static double? MVtoThA3(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] a1 = {
    //                          -1.0649133e-4,
    //                          1.1686475e-2,
    ...
    //    public static double? MVtoThM(double value, double cjc, out EChannelStatus status)
    //    {
    //        double[] a1 = {
    //                          2.4455560e-6,
    //                          4.2638917e-2,
    ...
    //    public static double? MVtoTh(string thType, double value, double cjc, out EChannelStatus status)
    //    {
    //        switch (thType)
    //        {
    ...
    //            default:
    //                status = EChannelStatus.TransformError;
    //                return null;
    //        }
    //    }

    //    /*public static double? SignalConversion(double value, string conversion, out EChannelStatus status)
    //    {
    //        string st = conversion.Trim();
    ...
    //        if (st.StartsWith("Расход(") && st.EndsWith(")"))
    //        {
    //            int i = "Расход(".Length;
    //            st = st.Substring(i, st.Length - i - 1);
    //            st = st.Replace(",", ".");
    //            double coef;

    //            //double num = double.Parse("1,5", CultureInfo.GetCultureInfo("de-DE").NumberFormat);
    //            if (double.TryParse(st, NumberStyles.Any, CultureInfo.InvariantCulture.NumberFormat, out coef))
    //            {
    //                try
    //                {
    //                    status = EChannelStatus.NoError;
    //                    return coef * Math.Sqrt(value);
    //                }
    //                catch
    //                {
    //                    status = EChannelStatus.ConversionCalcError;
    //                    return null;
    //                }
    //            }

    //            status = EChannelStatus.ConversionSyntaxError;
    //            return null;
    //        }

    //        if (st.StartsWith("Давление(") && st.EndsWith(")"))
    //        {
    ...
    //            if(j > 0)
    //            {
    //                st1 = st.Substring(j + 1, st.Length - j - 2);
    //                st = st.Substring(i, j - i);                    
    //            }
    //            else st.Substring(i, st.Length - i - 1);
    ...
    //    //свойства модуля
    //    public readonly ClassAbstractAdamModule Module;               //модуль
    //    public virtual string ChannelRange { get; set; }              //тип канала (настройка модуля)
    //    public string DataFormat { get{ return Module.DataFormat;} }  //формат данных

    //    //свойства, задаваемые пользователем
    //    public string Code { get; set; }              //код сигнала (например KKS)
    ...
    //     * 0: y = x
    //     * 1: y = c0 + c1 * x
    //     * 2: y = c0 + c1 * x + c2 * x^2 + c3 * x^3 + c4 * x^4 + c5 * x^5
    //     * 3: y = c0 + c1 * sqrt(x + c2)
    //     * 4: y = c0 + c1 * exp(c2 * x)
    //     * 5: y = sqrt(c0 + c1 * x + c2 * x^2 + c3 * x^3 + c4 * x^4 + c5 * x^5)
    //    */
    ...
    //    public int? ArchiveId { get; set; }         //индекс в архивном файле
        
    //    public ClassChannelValue CurrentValue { get; set; } //значение

    //    public string Signal { get { return CurrentValue != null ? CurrentValue.Signal : null; } }
    //    public double? Value { get { return CurrentValue != null ? CurrentValue.Value : null; } }
    //    public DateTime? Time { get { return CurrentValue != null ? (DateTime?)CurrentValue.Time : null; } }
    //    public EChannelStatus? Status { get { return CurrentValue != null ? (EChannelStatus?)CurrentValue.Status : null; } }
    //    public double? Val { get { return CurrentValue != null ? CurrentValue.Val : null; } }
    //    public double? NewValue { get { return CurrentValue != null ? CurrentValue.NewValue : null; } }
    //    public bool ValueChanged { get { return CurrentValue != null && CurrentValue.ValueChanged; } }

    //    public bool IsCjcChannel { get { return ChannelType == "AdamCJC"; } }
    //#endregion 

    //#region Constructors/Destructors
    //    protected ClassAbstractAdamChannel(ClassAbstractAdamModule module, int channel)
    //    {
    //        _channel = channel;
    //        Module = module;
            
    //        Code = "M" + Module.Address + "CH" + (channel + 1);
    //        Name = null;
    //        Aperture = null;
    //        Min = null;
    //        Max = null;
    ...
    //    public abstract void CalcVal(string signal, ref EChannelStatus status, out double? val);

    //    public virtual double? SignalConversion(double value, out EChannelStatus status)
    //    {
    ...
    //                {
    //                    status = EChannelStatus.NoError;
    //                    return Math.Sqrt(ConvCoef0 + ConvCoef1 * value + ConvCoef2 * Math.Pow(value, 2) + 
    //                                     ConvCoef3 * Math.Pow(value, 3) + ConvCoef4 * Math.Pow(value, 4) + 
    //                                     ConvCoef5 * Math.Pow(value, 5));
    //                }
    //                catch
    ...
    //public class ClassAdamCjcChannel : ClassAbstractAdamChannel
    //{
    //    public ClassAdamCjcChannel(ClassAbstractAdamModule module, int channel) : base(module, channel)
    //    {
    ...
    //public class ClassAdamChannelsList
    //{
    //    private readonly ClassAbstractAdamChannel[] _channel;

    //    public ClassAdamChannelsList(int channelCount)
    //    {
    //        _channel = new ClassAbstractAdamChannel[channelCount];
    //    }

    //    public ClassAdamChannelsList(ClassAbstractAdamChannel[] channels) : this(channels.GetLength(0))
    //    {
    //        //for (byte i = 0; i <= channels.GetUpperBound(0); i++) _channel[i] = channels[i];
    //        _channel = channels;
    //    }

    //    public int Count { get { return _channel.GetLength(0); } }

    //    public ClassAbstractAdamChannel this[int channel]
    //    {
    //        get
    //        {
    //            if ((channel >= 0) && (channel <= Count)) return _channel[channel];
    //            return null;
    //        }

    //        set
    //        {
    //            if (_channel[channel] == null) _channel[channel] = value;
    //        }
    //    }

    //    public IEnumerator GetEnumerator()
    //    {
    //        return _channel.GetEnumerator();
    //    }
    //}
}
